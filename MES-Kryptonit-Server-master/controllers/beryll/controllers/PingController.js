/**
 * ПАТЧ ДЛЯ routes/beryllRouter.js
 * 
 * Добавить роуты мониторинга (пинг серверов)
 */

// ============================================
// ШАГ 1: Добавить импорт в начало файла (после других импортов)
// ============================================

const PingController = require("../controllers/beryll/controllers/PingController");

// ============================================
// ШАГ 2: Добавить роуты мониторинга (перед module.exports)
// ============================================
